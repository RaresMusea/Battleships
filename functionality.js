...
autoButton.onclick=function(){GenerateComputerShips();
...
function SwapDecks(){
  ...
  if(d1.classList.contains('deck')){
    let audio=new Audio('Whoosh-In.mp3');
    audio.play();
  }
  ...
  if(d1.classList.contains('deck'))
  {
    ...
    let audio2=new Audio('Whoosh-Out.mp3');
    audio2.play();
    horizontaldeck=1;
  }
...
function ComputersTurn(){
  ...
  if(!UserArr[randomsquare].classList.contains('explode')){
    ...
    if(UserArr[randomsquare].classList.contains('deck')){
      let lastship= new Audio("You Are The Last Hope.mp3");
      if(UserArr[randomsquare].classList.contains('destroyer')){
        cpudestroyers=2;
        destroyedshipsbyai++;
        ...
        if(5-destroyedshipsbyai>1){
            ...
            let audio=new Audio("Torpedo Tubes Destroyed.mp3");
        ...
        if(UserArr[randomsquare].classList.contains('submarine')){
          ...
          if(5-destroyedshipsbyai>1){
            ...
            let destroyed=new Audio("Destroyed.mp3");
        ...
        if(UserArr[randomsquare].classList.contains('cruiser')){
          ...
          if(5-destroyedshipsbyai>1){
            ...
            let flood=new Audio("We're Flooding Quickly1.mp3");
        ...
        if(UserArr[randomsquare].classList.contains('battleship')){
          ...
          if(5-destroyedshipsbyai>1){
            ...
            let flooding= new Audio("We're Taking On Water Quickly.mp3");
        ...
        if(UserArr[randomsquare].classList.contains('carrier')){
          ...
          if(5-destroyedshipsbyai>1){
            ...
            let audio=new Audio("The Ship Is On Fire.mp3");
...
StartButton.onclick=function(){
  lessTheOppacity();
  let battle=new Audio("Battle Starts.mp3");
  battle.play();
...
if(patrat.classList.contains('warship')){
  ...
  audio.play();
    ...
    let audio=new Audio("Missed Shot.mp3");
    audio.play();
    }
  }
...
if(patrat.classList.contains('deck')){
  ...
  if(patrat.classList.contains('destroyer')){
    ...
    setTimeout(()=>{FadeOut();},2200);
    let audio=new Audio("We've sunk an enemy destroyer.mp3");
    setTimeout(()=>{audio.play();},1500);
    }
    ...
    if(patrat.classList.contains('submarine')){
      ...
      let audio=new Audio("Enemy Damaged.mp3");
      setTimeout(()=>{audio.play();},1500);
    }
    ...
    if(patrat.classList.contains('cruiser')){
      ...
      let audio=new Audio("Enemy Cruiser Sunk.mp3");
      setTimeout(()=>{audio.play();},1500);
    }
    ...
    if(patrat.classList.contains('battleship')){
      ...
      let audio=new Audio("Enemy Battleship Destroyed.mp3");
      setTimeout(()=>{audio.play();},1500);
    }
    ...
    if(patrat.classList.contains('carrier')){
      ...
      let audio=new Audio("Enemy Aircraft Carrier Destroyed.mp3");
      setTimeout(()=>{audio.play();},1500);}
    }   
}
...
function CheckForWins()
{
  ...
  if(destroyedshipsbyuser===5){
    ...
    let audio=new Audio('Our Victory.mp3');
  ...
  if(destroyedshipsbyai===5){
    ...
    let audio=new Audio('The Enemy Team is taking the lead.mp3');
    setTimeout(()=>{audio.play();},3500);
    restart.style.display="block;";
    GameOver();
  }
